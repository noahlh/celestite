...
import webpackServerConfig from "../webpack/webpack-vue-server-cfg.js";
import webpackClientConfig from "../webpack/webpack-vue-client-cfg.js";
...
//  Try reading the files first (if we're in production, they should already be compiled...)
if (NODE_ENV !== "development") {
  try {
    ...
    console.error(
      "Error reading server bundle / client manifest: " + e.message
    );
  }
}
